...
/mob/living/carbon/proc/random_stress_message()
	...
	var/stress_message_picked
	switch(user.patron.type)
		if(/datum/patron/divine/undivided)
			stress_message_picked = pick(GLOB.stress_messages_undivided)
		if(/datum/patron/divine/astrata)
			stress_message_picked = pick(GLOB.stress_messages_astrata)
		if(/datum/patron/divine/noc)
			stress_message_picked = pick(GLOB.stress_messages_noc)
		if(/datum/patron/divine/dendor)
			stress_message_picked = pick(GLOB.stress_messages_dendor)
		if(/datum/patron/divine/abyssor)
			stress_message_picked = pick(GLOB.stress_messages_abyssor)
		if(/datum/patron/divine/ravox)
			stress_message_picked = pick(GLOB.stress_messages_ravox)
		if(/datum/patron/divine/necra)
			stress_message_picked = pick(GLOB.stress_messages_necra)
		if(/datum/patron/divine/xylix)
			stress_message_picked = pick(GLOB.stress_messages_xylix)
		if(/datum/patron/divine/pestra)
			stress_message_picked = pick(GLOB.stress_messages_pestra)
		if(/datum/patron/divine/malum)
			stress_message_picked = pick(GLOB.stress_messages_malum)
		if(/datum/patron/inhumen/zizo)
			stress_message_picked = pick(GLOB.stress_messages_zizo)
		if(/datum/patron/inhumen/graggar)
			stress_message_picked = pick(GLOB.stress_messages_graggar)
		if(/datum/patron/inhumen/matthios)
			stress_message_picked = pick(GLOB.stress_messages_matthios)
		if(/datum/patron/inhumen/baotha)
			stress_message_picked = pick(GLOB.stress_messages_baotha)
		if(/datum/patron/old_god)
			stress_message_picked = pick(GLOB.stress_messages_psydon)
		//else
			//stress_message_picked = pick(GLOB.stress_messages_common)
